...
if( is_single() ) {
	if( ! $hide_post_paging ) { //ver1.0.1
		...
		<div class="post-nav-link weluka-mgtop-xl sp-pad clearfix">
			<div class="pull-left pull-link"><?php previous_post_link('%link', __( '&laquo; 前の記事へ', $weluka_themename ),true,'' ); ?></div>
			<div class="pull-right pull-link"><?php next_post_link('%link', __( '後ろの記事へ &raquo;', $weluka_themename ),true,'' ); ?> </div>
    	</div>
